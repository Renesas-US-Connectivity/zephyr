...
static const struct erpc_wifi_spi_config erpc_wifi_config_spi0 = {
	.dr = GPIO_DT_SPEC_INST_GET(0, rdy_gpios),
	.intr = GPIO_DT_SPEC_INST_GET(0, int_gpios),
...
erpc_transport_t erpc_wifi_transport_init(void)
{
	...
	return erpc_transport_zephyr_spi_master_init((void *)&cfg->bus, (void *)&cfg->dr, (void *)&cfg->intr);
}
