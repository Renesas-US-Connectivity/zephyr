...
static const struct erpc_wifi_spi_config erpc_wifi_config_spi0 = {
	.dr = GPIO_DT_SPEC_INST_GET(0, data_rdy_gpios),
	.bus = SPI_DT_SPEC_INST_GET(0, SPI_OP_MODE_MASTER | SPI_MODE_CPOL | SPI_WORD_SET(8), 0)
};
...
erpc_transport_t erpc_wifi_transport_init(void)
{
	...
	return erpc_transport_zephyr_spi_master_init((void *)&cfg->bus, (void *)&cfg->dr);
}
